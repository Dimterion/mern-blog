...
export default function Post() {
  ...
  return (
    <main className="p-3 flex flex-col max-w-7xl mx-auto min-h-screen">
      ...
      />
      <aside className="flex justify-between p-3 border-b border-slate-500 mx-auto w-full max-w-2xl text-xs">
      ...
      <section className="flex flex-col justify-center items-center mb-5">
        ...
        <article className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 mt-5 justify-center">
          {recentPosts &&
